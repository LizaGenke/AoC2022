...
with open(input) as f:
    while True:
        ...
        if (((first_range_numbers[0] <= second_range_numbers[0]) and (first_range_numbers[1]>=second_range_numbers[1])) or 
            ((first_range_numbers[0] >= second_range_numbers[0]) and (first_range_numbers[1]<=second_range_numbers[1]))):
